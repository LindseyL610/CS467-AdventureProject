...
class Thing:
    """The basic class for all objects in the game"""
	...
	def __init__(self, id, name):
		...
		# GENERIC Functions that will behave differently based on type of Thing
			# look() - say long description
			# go() - say "You can't go there!", return false
			# take() - say "You can't take that!", return false
			# drop() - say "You can't drop that!", return false
			# put() - say "You can't do that!", return false
			# open() - say "You can't open that!", return false
			# unlock() - say "You can't unlock that!", return false
			# check_status() return false
			# perform_action(verb)
				# get response[verb]
					# response found?
						# if so,
		...
		# Room, Exit, Feature, Puzzle and KeyboardPuzzle sub-classes inherit all of above, plus have specialized attributes
    ...
    def perform_action(self, action):
        #does this action have a special effect?
			#if not, return a default message "You __ the __. Nothing happened!"
			#if it does have a special effect
				#what changes occur?
				#what should be displayed? (return)
